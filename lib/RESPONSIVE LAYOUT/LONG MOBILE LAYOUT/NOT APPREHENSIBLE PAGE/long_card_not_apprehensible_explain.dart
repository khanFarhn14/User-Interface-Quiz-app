...
import 'long_descrptn_smoothing_not_apprehensible.dart';

// ignore: must_be_immutable
class LongCardNtApprhnsbleExplain extends StatefulWidget 
{
  double cardWidth;
  double cardHeight;
  LongCardNtApprhnsbleExplain({Key? key, required this.cardWidth, required this.cardHeight}) : super(key: key);

  @override
  // ignore: no_logic_in_create_state
  State<LongCardNtApprhnsbleExplain> createState() => _LongCardNtApprhnsbleExplainState(cardWidth, cardHeight);
}

class _LongCardNtApprhnsbleExplainState extends State<LongCardNtApprhnsbleExplain> {
  late double cardWidth;
  late double cardHeight;

  _LongCardNtApprhnsbleExplainState(this.cardWidth, this.cardHeight);
    ...
    (
      ...
      [
        ...
        (
          ...
          child: LongDescrptnCardNtApprnhsble()
        ),
